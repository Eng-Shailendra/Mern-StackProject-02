...
const SearchComponet = ({ items, query, setQuery, sort, setSort }) => {
  return (
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none px-4 py-3 border border-gray-200 rounded-xl pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
